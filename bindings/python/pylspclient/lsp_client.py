...
class LspClient(object):
    ...
    def initialize(self, processId, rootPath, rootUri, initializationOptions, capabilities, trace, workspaceFolders):
        ...
        return self.lsp_endpoint.call_method("initialize", processId=processId, rootPath=rootPath, rootUri=rootUri,
                                             initializationOptions=initializationOptions, capabilities=capabilities,
                                             trace=trace, workspaceFolders=workspaceFolders)
    ...
    def didChange(self, textDocument, contentChanges):
        ...
        :param TextDocumentContentChangeEvent[] contentChanges: The actual content changes. The content changes describe single state changes
            ...
            to S' and c2 to S''.
        """
        return self.lsp_endpoint.send_notification("textDocument/didChange", textDocument=textDocument,
    ...
    def definition(self, textDocument, position):
        ...
        """
        result_dict = self.lsp_endpoint.call_method("textDocument/definition", textDocument=textDocument,
                                                    position=position)
    ...
    def signatureHelp(self, textDocument, position):
        ...
        :param Position position: The position inside the text document.
        """
        result_dict = self.lsp_endpoint.call_method("textDocument/signatureHelp", textDocument=textDocument,
                                                    position=position)
    ...
    def completion(self, textDocument, position, context):
        ...
        """
        result_dict = self.lsp_endpoint.call_method("textDocument/completion", textDocument=textDocument,
    ...
    def declaration(self, textDocument, position):
        ...
        :param Position position: The position inside the text document.
        """
        result_dict = self.lsp_endpoint.call_method("textDocument/declaration", textDocument=textDocument,
                                                    position=position)
